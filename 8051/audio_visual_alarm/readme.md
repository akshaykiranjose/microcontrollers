...
1. When the temperature exceeds the set value and LED starts blinking at 2Hz frequency, indicating a visual alarm
...
2. If visual alarm is not acknowledged, the speaker starts generating a sound in any audible frequency, giving an
